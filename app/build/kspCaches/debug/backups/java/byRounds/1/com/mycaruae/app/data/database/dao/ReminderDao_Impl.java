...
public final class ReminderDao_Impl implements ReminderDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfDeleteAutoByType;
  ...
  public ReminderDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__preparedStmtOfDeleteAutoByType = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM reminders WHERE vehicleId = ? AND type = ? AND isAutoGenerated = 1 AND status = 'PENDING'";
        return _query;
      }
    };
  ...
  @Override
  public Object deleteAutoByType(final String vehicleId, final String type,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteAutoByType.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfDeleteAutoByType.release(_stmt);
        }
      }
    }, $completion);
  }
