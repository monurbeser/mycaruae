...
public final class DatabaseModule_ProvideVehicleDaoFactory implements Factory<VehicleDao> {
  ...
  public DatabaseModule_ProvideVehicleDaoFactory(Provider<CocDatabase> dbProvider) {
  ...
  public static DatabaseModule_ProvideVehicleDaoFactory create(Provider<CocDatabase> dbProvider) {
    return new DatabaseModule_ProvideVehicleDaoFactory(dbProvider);
  }

  public static VehicleDao provideVehicleDao(CocDatabase db) {
