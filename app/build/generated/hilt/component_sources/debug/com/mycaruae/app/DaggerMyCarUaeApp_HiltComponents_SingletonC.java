...
public final class DaggerMyCarUaeApp_HiltComponents_SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new DashboardViewModel(singletonCImpl.vehicleRepositoryProvider.get(), singletonCImpl.brandRepositoryProvider.get(), singletonCImpl.userPreferencesProvider.get());
          ...
          case 9: // com.mycaruae.app.feature.splash.SplashViewModel 
          return (T) new SplashViewModel(singletonCImpl.userPreferencesProvider.get());

          case 10: // com.mycaruae.app.feature.vehicle.VehicleAddViewModel 
          ...
          case 11: // com.mycaruae.app.feature.vehicle.VehicleEditViewModel 
          return (T) new VehicleEditViewModel(singletonCImpl.vehicleRepositoryProvider.get(), singletonCImpl.brandRepositoryProvider.get(), singletonCImpl.emirateRepositoryProvider.get(), singletonCImpl.userPreferencesProvider.get());
  ...
  private static final class SingletonCImpl extends MyCarUaeApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.maintenanceRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<MaintenanceRepository>(singletonCImpl, 10));
      this.mileageRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<MileageRepository>(singletonCImpl, 11));
      this.emirateRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<EmirateRepository>(singletonCImpl, 12));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 10: // com.mycaruae.app.data.repository.MaintenanceRepository 
          ...
          case 12: // com.mycaruae.app.data.repository.EmirateRepository 
