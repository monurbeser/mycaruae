...
public final class DashboardViewModel_Factory implements Factory<DashboardViewModel> {
  ...
  public DashboardViewModel get() {
    return newInstance(vehicleRepositoryProvider.get(), brandRepositoryProvider.get(), userPreferencesProvider.get());
  }
  ...
  public static DashboardViewModel_Factory create(
      ...
      Provider<BrandRepository> brandRepositoryProvider,
      Provider<UserPreferences> userPreferencesProvider) {
    return new DashboardViewModel_Factory(vehicleRepositoryProvider, brandRepositoryProvider, userPreferencesProvider);
  }

  public static DashboardViewModel newInstance(VehicleRepository vehicleRepository,
      BrandRepository brandRepository, UserPreferences userPreferences) {
    return new DashboardViewModel(vehicleRepository, brandRepository, userPreferences);
  }
}
