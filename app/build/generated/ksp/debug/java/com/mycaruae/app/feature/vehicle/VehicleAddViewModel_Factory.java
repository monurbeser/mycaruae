...
public final class VehicleAddViewModel_Factory implements Factory<VehicleAddViewModel> {
  ...
  public VehicleAddViewModel_Factory(Provider<VehicleRepository> vehicleRepositoryProvider,
  ...
  @Override
  public VehicleAddViewModel get() {
  ...
  public static VehicleAddViewModel_Factory create(
      Provider<VehicleRepository> vehicleRepositoryProvider,
      Provider<BrandRepository> brandRepositoryProvider,
      Provider<EmirateRepository> emirateRepositoryProvider,
      Provider<ReminderRepository> reminderRepositoryProvider,
      Provider<UserPreferences> userPreferencesProvider) {
    return new VehicleAddViewModel_Factory(vehicleRepositoryProvider, brandRepositoryProvider, emirateRepositoryProvider, reminderRepositoryProvider, userPreferencesProvider);
  }

  public static VehicleAddViewModel newInstance(VehicleRepository vehicleRepository,
    ...
    return new VehicleAddViewModel(vehicleRepository, brandRepository, emirateRepository, reminderRepository, userPreferences);
  }
}
