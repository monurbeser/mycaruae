...
interface ReminderDao {
    ...
    @Query("DELETE FROM reminders WHERE vehicleId = :vehicleId AND type = :type AND isAutoGenerated = 1 AND status = 'PENDING'")
    suspend fun deleteAutoByType(vehicleId: String, type: String)
